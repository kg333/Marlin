...
#define STRING_CONFIG_H_AUTHOR "(kg333, SKR Mini E3 V2.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MakerSel"
...
//#define Z2_DRIVER_TYPE TMC2209 // board has two ports, but only one stepper
